...
results_df$Parameter <- c("beta1", "beta2", "gamma11", "gamma21", "gamma12", "gamma22",
                          "delta111", "delta211", "delta121", "delta221",
                          "delta112", "delta212", "delta122", "delta222",
                          "beta1", "beta2", "delta111", "delta211", "delta122", "delta222",
                          "beta1", "beta2", "gamma11", "gamma12", "gamma21", "gamma22",
                          "delta111", "delta112", "delta121", "delta122",
                          "delta211", "delta212", "delta221", "delta222")
results_df$place_holder <- 1
results_df$True_Value <- c(c(true_beta), c(true_gamma), c(true_delta),
                           c(true_beta), c(true_delta[,1,1]), c(true_delta[,2,2]),
                           c(true_beta), true_gamma[1,], true_gamma[2,],
                           c(true_delta[1,,][1,]), c(true_delta[1,,][2,]),
                           c(true_delta[2,,][1,]), c(true_delta[2,,][2,]))

ggplot(data = results_df %>%
         filter(str_detect(Parameter, "beta") |
                  str_detect(Parameter, "gamma"))) +
